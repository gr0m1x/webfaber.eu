...
gulp.task('iconfont', function () { // svg font
    ...
    var processors = [
        assets({
            loadPaths: ['dist/font/', 'dist/img/', 'dist/img_clients/'],
            basePath: 'dist/',
            relative: true
        })
    ]
...
gulp.task('watch', function () {
    ...
    gulp.watch('dev/**/*.{{.png,.jpg,.jpeg,.gif}}', ['asset_img'])
...
gulp.task('default', ['iconfont','scripts', 'asset_font', 'post-css', 'asset_html', 'js', 'asset_img', 'brow_sync', 'watch']);
